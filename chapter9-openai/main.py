...
tools = [search_ddg]
agent = Agent(model="litellm/gemini/gemini-2.5-flash", name="Assistant", instructions="You are a helpful assistant", tools=tools)
result = Runner.run_sync(agent, "2024年1月の日本のトップニュースは何? search_ddgツールを使用して回答して")
