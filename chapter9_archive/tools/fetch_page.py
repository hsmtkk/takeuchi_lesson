...
#             url, headers={"User-Agent": "dummy"}, timeout=timeout_sec
#         )
...
#             "page_content": {
#                 "error_message": "Could not download page. Please try to fetch other pages."
#             },
#         }
...
#             "status": 500,
#             "page_content": {
#                 "error_message": "Could not parse page. Please try to fetch other pages."
#             },
#         }
...
#             "status": 500,
#             "page_content": {
#                 "error_message": "page_num parameter looks invalid. Please try to fetch other pages."
#             },
#         }
#     elif page_num >= 3:
#         return {
#             "status": 503,
#             "page_content": {
#                 "error_message": "Reading more of the page_num's content will overload your memory. Please provide your response based on the information you currently have."
#             },
#         }
#     else:
#         return {
...
@tool(
    ...
    description="指定されたURLからウェブページのコンテンツを取得する",
)
def fetch_page(url) -> str:
    response = requests.get(url, headers={"User-Agent": "dummy"})
    response.encoding = "utf-8"
